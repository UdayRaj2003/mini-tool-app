...
function renderTools() {
  ...
  tools.forEach(tool => {
    ...
    favIcon.className = "fav-icon ml-auto w-[45px] h-[45px] rounded-full border border-border flex items-center justify-center cursor-pointer transition-transform duration-150 ease-[cubic-bezier(0.25,0.1,0.25,1)] bg-accent-light hover:shadow-[0_0_0_4px_rgba(0,0,0,0.04)]";
